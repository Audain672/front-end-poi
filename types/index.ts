...
// ============================================================================
// TYPES POUR LES ACTIONS D'ADMINISTRATION (AJOUTÉS)
// ============================================================================
export interface POIValidationData {
poi_id: string;
validated_by: string;
validated_by_name: string;
validated_at: string; // ISO String date
}
export interface POIRejectionData {
poi_id: string;
rejected_by: string;
rejected_at: string; // ISO String date
rejection_reason?: string;
}